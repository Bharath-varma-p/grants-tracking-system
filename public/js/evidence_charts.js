function startChartEvidence(data) {
  //Special Table Column Names
  $("#th7").text("Date");
  $("#th8").text("Address");
  $("#th9").text("Submitted By");
  $("#th10").text("Room Location");
  ...
  function chartStart() {
    ...
    barchart1 = xf.dimension(function (d) {
      let returnValue;
      if (field_name1 == "room_location") {
        returnValue = d.room_location;
      }
      if (field_name1 == "IF(disposed=1,'Yes','No') as disposed") {
        returnValue = d.disposed;
      }
      if (field_name1 == "user") {
        returnValue = d.user;
      }
      if (field_name1 == "year(created_date) as year") {
        returnValue = +d.year;
      }
      if (field_name1 == "month(created_date) as month") {
        returnValue = d.month;
      }
      if (field_name1 == "dayname(created_date) as dayName") {
        returnValue = d.dayName;
      }
      if (field_name1 == "hour(created_date) as hour") {
        returnValue = +d.hour;
      }
      ...
      if (field_name1 == "PropertyType") {
        returnValue = d.PropertyType;
      }
      if (field_name1 == "evidence_no") {
        returnValue = d.evidence_no;
      }
      if (field_name1 == "fbi_no") {
        returnValue = d.fbi_no;
      }
      if (field_name1 == "date_format(created_date,'%m/%d/%Y') as incident_date") {
      ...
      if (field_name1 == "calculateAge( date_of_birth , created_date ) as age") {
        returnValue = d.age;
      }
      if (field_name1 == "orc_no") {
        returnValue = d.orc_no;
      }
      if (field_name1 == "additional_description") {
        returnValue = d.additional_description;
      }
      ...
      if (field_name1 == "submitted_by") {
        returnValue = d.submitted_by;
      }
      if (field_name1 == "description") {
        returnValue = d.description;
      }
      if (field_name1 == "checked_out") {
        returnValue = d.checked_out;
      }
      if (field_name1 == "recovery_address") {
        returnValue = d.recovery_address;
      }
      if (field_name1 == "stolen_property") {
        returnValue = d.stolen_property;
      }
  ...
  function chartStart2() {
    ...
    barchart2 = xf.dimension(function (d) {
      let returnValue;
      if (field_name2 == "room_location") {
        returnValue = d.room_location;
      }
      if (field_name2 == "date_format(date_of_birth,'%m/%d/%Y') as date_of_birth") {
        returnValue = d.incident_date;
      }
      if (field_name2 == "checked_out") {
        returnValue = d.checked_out;
      }
      if (field_name2 == "first_name") {
        returnValue = d.first_name;
      }
      if (field_name2 == "IF(stolen_property=1,'Yes','No') as stolen_property") {
        returnValue = d.stolen_property;
      }
      if (field_name2 == "last_name") {
        returnValue = d.last_name;
      }
      if (field_name2 == "calculateAge( date_of_birth , created_date ) as age") {
        returnValue = d.age;
      }
      if (field_name2 == "IF(disposed=1,'Yes','No') as disposed") {
        returnValue = d.disposed;
      }
      if (field_name2 == "user") {
        returnValue = d.user;
      }
      if (field_name2 == "year(created_date) as year") {
        returnValue = +d.year;
      }
      if (field_name2 == "month(created_date) as month") {
        returnValue = d.month;
      }
      if (field_name2 == "dayname(created_date) as dayName") {
        returnValue = d.dayName;
      }
      if (field_name2 == "hour(created_date) as hour") {
        returnValue = +d.hour;
      }
      ...
      if (field_name2 == "PropertyType") {
        returnValue = d.PropertyType;
      }
      if (field_name2 == "evidence_no") {
        returnValue = d.evidence_no;
      }
      if (field_name2 == "IF(checked_out is null,'Checked-in','Checked-out')") {
        returnValue = d.checked_out;
      }
      if (field_name2 == "date_format(created_date,'%m/%d/%Y') as incident_date") {
        returnValue = d.incident_date;
      }
      if (field_name2 == "orc_no") {
        returnValue = d.orc_no;
      }
      if (field_name2 == "additional_description") {
        returnValue = d.additional_description;
      }
      ...
      if (field_name2 == "submitted_by") {
        returnValue = d.submitted_by;
      }
      if (field_name2 == "description") {
        returnValue = d.description;
      }
      if (field_name2 == "recovery_address") {
        returnValue = d.recovery_address;
      }
  ...
  function chartStart3() {
    ...
    barchart3 = xf.dimension(function (d) {
      let returnValue;
      if (field_name3 == "room_location") {
        returnValue = d.room_location;
      }
      if (field_name3 == "IF(stolen_property=1,'Yes','No') as stolen_property") {
        returnValue = d.stolen_property;
      }
      ...
      if (field_name3 == "IF(checked_out is null,'Checked-in','Checked-out')") {
        returnValue = d.checked_out;
      }
      if (field_name3 == "last_name") {
        returnValue = d.last_name;
      }
      if (field_name3 == "calculateAge( date_of_birth , created_date ) as age") {
        returnValue = d.age;
      }
      if (field_name3 == "IF(disposed=1,'Yes','No') as disposed") {
        returnValue = d.disposed;
      }
      if (field_name3 == "user") {
        returnValue = d.user;
      }
      if (field_name3 == "year(created_date) as year") {
        returnValue = +d.year;
      }
      if (field_name3 == "month(created_date) as month") {
        returnValue = d.month;
      }
      if (field_name3 == "dayname(created_date) as dayName") {
        returnValue = d.dayName;
      }
      if (field_name3 == "hour(created_date) as hour") {
        returnValue = +d.hour;
      }
      ...
      if (field_name3 == "PropertyType") {
        returnValue = d.PropertyType;
      }
      if (field_name3 == "evidence_no") {
        returnValue = d.evidence_no;
      }
      if (field_name3 == "IF(checked_out is null,'Checked-in','Checked-out')") {
        returnValue = d.checked_out;
      }
      if (field_name3 == "date_format(created_date,'%m/%d/%Y') as incident_date") {
        returnValue = d.incident_date;
      }
      if (field_name3 == "orc_no") {
        returnValue = d.orc_no;
      }
      if (field_name3 == "additional_description") {
        returnValue = d.additional_description;
      }
      ...
      if (field_name3 == "submitted_by") {
        returnValue = d.submitted_by;
      }
      if (field_name3 == "description") {
        returnValue = d.description;
      }
      if (field_name3 == "recovery_address") {
        returnValue = d.recovery_address;
      }
  ...
  function chartStart4() {
    ...
    barchart4 = xf.dimension(function (d) {
      let returnValue;
      if (field_name4 == "room_location") {
        returnValue = d.room_location;
      }
      if (field_name4 == "IF(stolen_property=1,'Yes','No') as stolen_property") {
        returnValue = d.stolen_property;
      }
      if (field_name4 == "IF(checked_out is null,'Checked-in','Checked-out')") {
        returnValue = d.checked_out;
      }
      ...
      if (field_name4 == "calculateAge( date_of_birth , created_date ) as age") {
        returnValue = d.age;
      }
      if (field_name4 == "IF(disposed=1,'Yes','No') as disposed") {
        returnValue = d.disposed;
      }
      if (field_name4 == "user") {
        returnValue = d.user;
      }
      if (field_name4 == "year(created_date) as year") {
        returnValue = +d.year;
      }
      if (field_name4 == "month(created_date) as month") {
        returnValue = d.month;
      }
      if (field_name4 == "dayname(created_date) as dayName") {
        returnValue = d.dayName;
      }
      if (field_name4 == "hour(created_date) as hour") {
        returnValue = +d.hour;
      }
      ...
      if (field_name4 == "PropertyType") {
        returnValue = d.PropertyType;
      }
      if (field_name4 == "evidence_no") {
        returnValue = d.evidence_no;
      }
      if (field_name4 == "IF(checked_out is null,'Checked-in','Checked-out')") {
        returnValue = d.checked_out;
      }
      if (field_name4 == "date_format(created_date,'%m/%d/%Y') as incident_date") {
        returnValue = d.incident_date;
      }
      if (field_name4 == "orc_no") {
        returnValue = d.orc_no;
      }
      if (field_name4 == "additional_description") {
        returnValue = d.additional_description;
      }
      ...
      if (field_name4 == "submitted_by") {
        returnValue = d.submitted_by;
      }
      if (field_name4 == "description") {
        returnValue = d.description;
      }
      if (field_name4 == "recovery_address") {
        returnValue = d.recovery_address;
      }
  ...
  function chartStart5() {
    ...
    barchart5 = xf.dimension(function (d) {
      let returnValue;
      if (field_name5 == "room_location") {
        returnValue = d.room_location;
      }
      if (field_name5 == "IF(stolen_property=1,'Yes','No') as stolen_property") {
        returnValue = d.stolen_property;
      }
      if (field_name5 == "IF(checked_out is null,'Checked-in','Checked-out')") {
        returnValue = d.checked_out;
      }
      ...
      if (field_name5 == "calculateAge( date_of_birth , created_date ) as age") {
        returnValue = d.age;
      }
      ...
      if (field_name5 == "IF(disposed=1,'Yes','No') as disposed") {
        returnValue = d.disposed;
      }
      if (field_name5 == "user") {
        returnValue = d.user;
      }
      if (field_name5 == "year(created_date) as year") {
        returnValue = +d.year;
      }
      if (field_name5 == "month(created_date) as month") {
        returnValue = d.month;
      }
      if (field_name5 == "dayname(created_date) as dayName") {
        returnValue = d.dayName;
      }
      if (field_name5 == "hour(created_date) as hour") {
        returnValue = +d.hour;
      }
      if (field_name5 == "PropertyType") {
        returnValue = d.PropertyType;
      }
      if (field_name5 == "evidence_no") {
        returnValue = d.evidence_no;
      }
      if (field_name5 == "IF(checked_out is null,'Checked-in','Checked-out')") {
        returnValue = d.checked_out;
      }
      if (field_name5 == "date_format(created_date,'%m/%d/%Y') as incident_date") {
        returnValue = d.incident_date;
      }
      if (field_name5 == "orc_no") {
        returnValue = d.orc_no;
      }
      if (field_name5 == "additional_description") {
        returnValue = d.additional_description;
      }
      ...
      if (field_name5 == "submitted_by") {
        returnValue = d.submitted_by;
      }
      if (field_name5 == "description") {
        returnValue = d.description;
      }
      if (field_name5 == "recovery_address") {
        returnValue = d.recovery_address;
      }
      return typeof returnValue === "undefined" ? "" : returnValue;
    });
  ...
  function chartStart6() {
    ...
    barchart6 = xf.dimension(function (d) {
      let returnValue;
      if (field_name6 == "room_location") {
        returnValue = d.room_location;
      }
      if (field_name6 == "IF(stolen_property=1,'Yes','No') as stolen_property") {
        returnValue = d.stolen_property;
      }
      if (field_name6 == "IF(checked_out is null,'Checked-in','Checked-out')") {
        returnValue = d.checked_out;
      }
      ...
      if (field_name6 == "calculateAge( date_of_birth , created_date ) as age") {
        returnValue = d.age;
      }
      if (field_name6 == "IF(disposed=1,'Yes','No') as disposed") {
        returnValue = d.disposed;
      }
      if (field_name6 == "user") {
        returnValue = d.user;
      }
      if (field_name6 == "year(created_date) as year") {
        returnValue = +d.year;
      }
      if (field_name6 == "month(created_date) as month") {
        returnValue = d.month;
      }
      if (field_name6 == "dayname(created_date) as dayName") {
        returnValue = d.dayName;
      }
      if (field_name6 == "hour(created_date) as hour") {
        returnValue = +d.hour;
      }
      ...
      if (field_name6 == "PropertyType") {
        returnValue = d.PropertyType;
      }
      if (field_name6 == "evidence_no") {
        returnValue = d.evidence_no;
      }
      if (field_name6 == "IF(checked_out is null,'Checked-in','Checked-out')") {
        returnValue = d.checked_out;
      }
      if (field_name6 == "date_format(created_date,'%m/%d/%Y') as incident_date") {
        returnValue = d.incident_date;
      }
      if (field_name6 == "orc_no") {
        returnValue = d.orc_no;
      }
      if (field_name6 == "additional_description") {
        returnValue = d.additional_description;
      }
      ...
      if (field_name6 == "submitted_by") {
        returnValue = d.submitted_by;
      }
      if (field_name6 == "description") {
        returnValue = d.description;
      }
      if (field_name6 == "recovery_address") {
        returnValue = d.recovery_address;
      }
      ...
      columnDefs: [
        {
          ...
          data: function (d) {
            ...
            if (field_name1 == "evidence_no") {
              return d.evidence_no;
            }
            if (field_name1 == "IF(checked_out is null,'Checked-in','Checked-out')") {
              return d.checked_out;
            }
            if (field_name1 == "date_format(created_date,'%m/%d/%Y') as incident_date") {
            ...
            if (field_name1 == "additional_description") {
              return d.additional_description;
            }
            if (field_name1 == "user") {
              return d.user;
            }
            if (field_name1 == "submitted_by") {
              return d.submitted_by;
            }
            if (field_name1 == "description") {
