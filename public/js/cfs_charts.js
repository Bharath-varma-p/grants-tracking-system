function startChartCFS(data) {
  //Special Table Column Names
  $("#th7").text("Date");
  $("#th8").text("Address");
  $("#th9").text("Description");
  $("#th10").text("Description Group");
  ...
  function chartStart() {
    ...
    barchart1 = xf.dimension(function (d) {
      ...
      if (field_name1 == "year(TimePhonePickup) as year") {
        returnValue = +d.year;
      }
      if (field_name1 == "month(TimePhonePickup) as month") {
        returnValue = d.month;
      }
      if (field_name1 == "dayname(TimePhonePickup) as dayName") {
        returnValue = d.dayName;
      }
      if (field_name1 == "hour(TimePhonePickup) as hour") {
        returnValue = +d.hour;
      }
      ...
      if (field_name1 == "call_group") {
        returnValue = d.call_group;
      }
      ...
      if (field_name1 == "Division") {
        returnValue = d.Division;
      }
      if (field_name1 == "FinalProblemDescription") {
        returnValue = d.FinalProblemDescription;
      }
      if (field_name1 == "date_format(TimePhonePickup,'%m/%d/%Y') as incident_date") {
      ...
      if (field_name1 == "calculateAge( date_of_birth , TimePhonePickup ) as age") {
        returnValue = d.age;
      }
      if (field_name1 == "orc_no") {
        returnValue = d.orc_no;
      }
      if (field_name1 == "RadioName") {
        returnValue = d.RadioName;
      }
      ...
      if (
        field_name1 ==
        "Round(((TIMESTAMPDIFF(SECOND, CONVERT(TimeFirstUnitAssigned, TIME), CONVERT(TimeFirstUnitArrived, TIME)))/60),0) AS ResponseTime"
      ) {
        returnValue = d.ResponseTime;
      }
  ...
  function chartStart2() {
    ...
    barchart2 = xf.dimension(function (d) {
      ...
      if (field_name2 == "calculateAge( date_of_birth , TimePhonePickup ) as age") {
        returnValue = d.age;
      }
      if (field_name2 == "race") {
        returnValue = d.race;
      ...
      if (field_name2 == "year(TimePhonePickup) as year") {
        returnValue = +d.year;
      }
      if (field_name2 == "month(TimePhonePickup) as month") {
        returnValue = d.month;
      }
      if (field_name2 == "dayname(TimePhonePickup) as dayName") {
        returnValue = d.dayName;
      }
      if (field_name2 == "hour(TimePhonePickup) as hour") {
        returnValue = +d.hour;
      }
      ...
      if (field_name2 == "Division") {
        returnValue = d.Division;
      }
      if (field_name2 == "FinalProblemDescription") {
        returnValue = d.FinalProblemDescription;
      }
      if (field_name2 == "date_format(TimePhonePickup,'%m/%d/%Y') as incident_date") {
        returnValue = d.incident_date;
      }
      if (field_name2 == "orc_no") {
        returnValue = d.orc_no;
      }
      if (field_name2 == "RadioName") {
        returnValue = d.RadioName;
      }
  ...
  function chartStart3() {
    ...
    barchart3 = xf.dimension(function (d) {
      ...
      if (field_name3 == "calculateAge( date_of_birth , TimePhonePickup ) as age") {
        returnValue = d.age;
      }
      if (field_name3 == "race") {
        returnValue = d.race;
      ...
      if (field_name3 == "year(TimePhonePickup) as year") {
        returnValue = +d.year;
      }
      if (field_name3 == "month(TimePhonePickup) as month") {
        returnValue = d.month;
      }
      if (field_name3 == "dayname(TimePhonePickup) as dayName") {
        returnValue = d.dayName;
      }
      if (field_name3 == "hour(TimePhonePickup) as hour") {
        returnValue = +d.hour;
      }
      ...
      if (field_name3 == "Division") {
        returnValue = d.Division;
      }
      if (field_name3 == "FinalProblemDescription") {
        returnValue = d.FinalProblemDescription;
      }
      if (field_name3 == "date_format(TimePhonePickup,'%m/%d/%Y') as incident_date") {
        returnValue = d.incident_date;
      }
      if (field_name3 == "orc_no") {
        returnValue = d.orc_no;
      }
      if (field_name3 == "RadioName") {
        returnValue = d.RadioName;
      }
  ...
  function chartStart4() {
    ...
    barchart4 = xf.dimension(function (d) {
      ...
      if (field_name4 == "calculateAge( date_of_birth , TimePhonePickup ) as age") {
        returnValue = d.age;
      }
      if (field_name4 == "race") {
        returnValue = d.race;
      ...
      if (field_name4 == "year(TimePhonePickup) as year") {
        returnValue = +d.year;
      }
      if (field_name4 == "month(TimePhonePickup) as month") {
        returnValue = d.month;
      }
      if (field_name4 == "dayname(TimePhonePickup) as dayName") {
        returnValue = d.dayName;
      }
      if (field_name4 == "hour(TimePhonePickup) as hour") {
        returnValue = +d.hour;
      }
      ...
      if (field_name4 == "Division") {
        returnValue = d.Division;
      }
      if (field_name4 == "FinalProblemDescription") {
        returnValue = d.FinalProblemDescription;
      }
      if (field_name4 == "date_format(TimePhonePickup,'%m/%d/%Y') as incident_date") {
        returnValue = d.incident_date;
      }
      if (field_name4 == "orc_no") {
        returnValue = d.orc_no;
      }
      if (field_name4 == "RadioName") {
        returnValue = d.RadioName;
      }
  ...
  function chartStart5() {
    ...
    barchart5 = xf.dimension(function (d) {
      ...
      if (field_name5 == "calculateAge( date_of_birth , TimePhonePickup ) as age") {
        returnValue = d.age;
      }
      ...
      if (field_name5 == "year(TimePhonePickup) as year") {
        returnValue = +d.year;
      }
      if (field_name5 == "month(TimePhonePickup) as month") {
        returnValue = d.month;
      }
      if (field_name5 == "dayname(TimePhonePickup) as dayName") {
        returnValue = d.dayName;
      }
      if (field_name5 == "hour(TimePhonePickup) as hour") {
        returnValue = +d.hour;
      }
      if (field_name5 == "SSN") {
        returnValue = d.SSN;
      }
      if (field_name5 == "Division") {
        returnValue = d.Division;
      }
      if (field_name5 == "FinalProblemDescription") {
        returnValue = d.FinalProblemDescription;
      }
      if (field_name5 == "date_format(TimePhonePickup,'%m/%d/%Y') as incident_date") {
        returnValue = d.incident_date;
      }
      if (field_name5 == "orc_no") {
        returnValue = d.orc_no;
      }
      if (field_name5 == "RadioName") {
        returnValue = d.RadioName;
      }
  ...
  function chartStart6() {
    ...
    barchart6 = xf.dimension(function (d) {
      ...
      if (field_name6 == "calculateAge( date_of_birth , TimePhonePickup ) as age") {
        returnValue = d.age;
      }
      if (field_name6 == "race") {
        returnValue = d.race;
      ...
      if (field_name6 == "year(TimePhonePickup) as year") {
        returnValue = +d.year;
      }
      if (field_name6 == "month(TimePhonePickup) as month") {
        returnValue = d.month;
      }
      if (field_name6 == "dayname(TimePhonePickup) as dayName") {
        returnValue = d.dayName;
      }
      if (field_name6 == "hour(TimePhonePickup) as hour") {
        returnValue = +d.hour;
      }
      ...
      if (field_name6 == "Division") {
        returnValue = d.Division;
      }
      if (field_name6 == "FinalProblemDescription") {
        returnValue = d.FinalProblemDescription;
      }
      if (field_name6 == "date_format(TimePhonePickup,'%m/%d/%Y') as incident_date") {
        returnValue = d.incident_date;
      }
      if (field_name6 == "orc_no") {
        returnValue = d.orc_no;
      }
      if (field_name6 == "RadioName") {
        returnValue = d.RadioName;
      }
      ...
      columnDefs: [
        {
          ...
          data: function (d) {
            ...
            if (field_name1 == "FinalProblemDescription") {
              return d.FinalProblemDescription;
            }
            if (field_name1 == "date_format(TimePhonePickup,'%m/%d/%Y') as incident_date") {
