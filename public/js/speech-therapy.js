...
var data = [  
  ...
  {  
    ...
    //$.get("//raw.githubusercontent.com/the-creature/language-json/master/data.json", function(data) {
        ...
        $.each(data, function(iki) {
            var option = $('<option/>')
                    .attr('value', data[iki].code)
                    .html(data[iki].name)
                    .appendTo(cList);
        });
    ...
    if (!('webkitSpeechRecognition' in window)) {
        ...
        recognition.onstart = function() {
            ...
            $('#recording_gif').show();
            $('#pause_button').show();
            talk_button.innerHTML = '<i class="fa fa-microphone"></i>';
            artyom.fatality();
        };
        ...
        recognition.onresult = function(event) {
            ...
            for (var i = event.resultIndex; i < event.results.length; ++i) {
                if (event.results[i].isFinal) {
                    ...
                    $(".use-editor").summernote("insertText", event.results[i][0].transcript );
                   // document.getElementById("narrative").innerHTML += event.results[i][0].transcript;

                    message.innerHTML = 'Click and begin speaking.';
                    talk_button.innerHTML = '<i class="fa fa-microphone"></i>';
                    ...
                    interim_transcript += event.results[i][0].transcript;
                     ...
                     message.innerHTML = '<img src="../../images/recording.gif" alt="Mountain View" id ="recording_gif" style="height: 20px; width:20px; margin-left: 20px;">';
                    talk_button.innerHTML = '<i class="fa fa-microphone"></i>';
    ...
    $('#pause_button').on('click', function() {
            ...
            $(this).hide();
            $('#recording_gif').hide();
            console.info('speech detection has stopped.');
		});
    ...
    */
    $(document).ready(function() {
        ...
        setTimeout(function(){
            var userLang = navigator.language || navigator.userLanguage;
            //$(document).find("#language").val('fr').change();
            //$("#language").val(userLang).change();
            //$("#language").val(userLang);
        }, 200);
   ...
   // $('#narrative').val('{{narrative}}');
    ...
    function vc_search(message) {
        ...
        phrase_prev = $('#narrative').val();
        
        var finaldictation = $('#narrative').val($('#narrative').val() + phrase + " ");
      ...
      artyom.initialize({
        ...
        $("#artyom_button").on('click',function(){
            artyom.say($("#narrative").val());
        });
    ...
    function common(s) {
        var words = ["qui","que","quoi","le","la","les","ont","il","ils","elle","elles","lui","est","je","tu","il","nous","vous","ils","de","duQ","desQ","sont","son","quel","quels","quelle","quelles"];
