!(function (t, e) {
      ...
      (function (t, e) {
        ...
        try {
          for (
            ...
            !(r = (a = o.next()).done) && (i.push(a.value), !e || i.length !== e);
            r = !0
          );
        } catch (t) {
          (n = !0), (s = t);
      ...
      attr: function (t, e, i) {
        ...
        for (r = (s = t.attributes).length; r--; )
          (n = s[r]) &&
            n.specified &&
            a.test(n.name) &&
            (i[this.camelize(n.name.slice(e.length))] = this.deserializeValue(n.value));
        return i;
      },
      ...
      deserializeValue: function (e) {
        ...
        try {
          return e
            ? "true" == e ||
                ("false" != e &&
                  ("null" == e ? null : isNaN((t = Number(e))) ? (/^[\[\{]/.test(e) ? JSON.parse(e) : e) : t))
            : e;
        } catch (t) {
          return e;
        }
  ...
  r.prototype = {
    ...
    asyncIsValid: function (t, e) {
      return (
        d.warnOnce("asyncIsValid is deprecated; please use whenValid instead"), this.whenValid({ group: t, force: e })
      );
    },
      ...
      return this.options.multiple
        ? h(
            this.parent.element.querySelectorAll(
              "[".concat(this.options.namespace, 'multiple="').concat(this.options.multiple, '"]')
            )
          )
        : this.$element;
    },
  ...
  c.prototype = {
    validate: function (t, e) {
      ...
      if (this.validateDate && i._isDateInput())
        return (
          (arguments[0] = d.parse.date(arguments[0])), null !== arguments[0] && this.validateDate.apply(this, arguments)
        );
      if (this.validateNumber)
        return (
          !t || (!isNaN(t) && ((arguments[0] = parseFloat(arguments[0])), this.validateNumber.apply(this, arguments)))
        );
  ...
  a.prototype = {
    ...
    addValidator: function (t, e, i) {
      if (this.validators[t]) d.warn('Validator "' + t + '" is already defined.');
        ...
        return void d.warn('"' + t + '" is a restricted keyword and is not a valid validator name.');
              ...
              ? (this._insertErrorWrapper(),
                0 === this._ui.$errorsWrapper.find(".parsley-custom-error-message").length &&
                  this._ui.$errorsWrapper.append(
                    h(this.options.errorTemplate).addClass("parsley-custom-error-message")
                  ),
      ...
      _buildUI: function () {
        if (!this._ui && !1 !== this.options.uiEnabled) {
          ...
          this.element.setAttribute(this.options.namespace + "id", this.__id__),
            ...
            (t.errorsWrapperId =
              "parsley-id-" + (this.options.multiple ? "multiple-" + this.options.multiple : this.__id__)),
    ...
    _submit: function (t) {
      if (!1 !== this._trigger("submit")) {
        if (t) {
          ...
          0 === e.length &&
            (e = h('<input class="parsley-synthetic-submit-button" type="hidden">').appendTo(this.$element)),
  ...
  w.prototype = {
    validate: function (t) {
      1 <= arguments.length &&
        !h.isPlainObject(t) &&
        (d.warnOnce("Calling validate on a parsley field without passing arguments as an object is deprecated."),
        (t = { options: t }));
    ...
    _bindConstraints: function () {
      for (var t = [], e = {}, i = 0; i < this.constraints.length; i++)
        !1 === this.constraints[i].isDomConstraint &&
          (t.push(this.constraints[i]), (e[this.constraints[i].name] = this.constraints[i]));
    ...
    handleMultiple: function () {
      ...
      if (
        ((this.options.multiple =
          this.options.multiple || (t = this.element.getAttribute("name")) || this.element.getAttribute("id")),
        "SELECT" === this.element.nodeName && null !== this.element.getAttribute("multiple"))
      )
    ...
    h.each(d, function (t, e) {
      "function" == typeof e &&
        (window.ParsleyUtils[t] = function () {
          return (
            d.warnOnce("Accessing `window.ParsleyUtils` is deprecated. Use `window.Parsley.Utils` instead."),
  ...
  (window.ParsleyValidator = {}),
    ...
    (window.ParsleyUI = {
      ...
      getErrorsMessages: function (t) {
        return (
          d.warnOnce("Accessing UI is deprecated. Call 'getErrorsMessages' on the instance directly."),
          t.getErrorsMessages()
        );
      },
    }),
    ...
    new (function () {
      ...
      l(this, {
        ...
        misbehaves: function (t) {
          r.isNativeEvent(t) &&
            (r.behavesOk(t),
            h(document).on("change.inputevent", t.data.selector, r.fakeInputEvent),
            r.fakeInputEvent(t));
        },
        ...
        install: function () {
          if (!n.inputEventPatched) {
            ...
            for (
              var t = 0, e = ["select", 'input[type="checkbox"]', 'input[type="radio"]', 'input[type="file"]'];
              t < e.length;
              t++
            ) {
              var i = e[t];
