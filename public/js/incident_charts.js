function startChartIncident(data) {
  //Special Table Column Names
  $("#th7").text("Date");
  $("#th8").text("Address");
  $("#th9").text("Weather Info");
  $("#th10").text("Officer");
  ...
  function chartStart() {
    ...
    barchart1 = xf.dimension(function (d) {
      ...
      if (field_name1 == "date_format(incident_date,'%m/%d/%Y') as incident_date") {
      ...
      if (field_name1 == "calculateAge( date_of_birth , IFNULL(incident.occurred_from, incident.date_time ) ) as age") {
        returnValue = d.age;
      }
      ...
      if (field_name1 == "lp_plate_number") {
        returnValue = d.lp_plate_number;
      }
      ...
      if (
        field_name1 ==
        "IF(((LENGTH(incident.orc_no) < 2) OR ISNULL(incident.orc_no)), CONCAT(incident.non_incident, ' -- Incident'), CONCAT(orc_codes.Nonviolent, ' -- Offense')) AS crime_name"
      ) {
  ...
  function chartStart2() {
    ...
    barchart2 = xf.dimension(function (d) {
      ...
      if (field_name2 == "calculateAge( date_of_birth , IFNULL(incident.occurred_from, incident.date_time ) ) as age") {
        returnValue = d.age;
      }
      if (field_name2 == "race") {
        returnValue = d.race;
      ...
      if (field_name2 == "date_format(incident_date,'%m/%d/%Y') as incident_date") {
        returnValue = d.incident_date;
      }
      ...
      if (field_name2 == "lp_plate_number") {
        returnValue = d.lp_plate_number;
      }
  ...
  function chartStart3() {
    ...
    barchart3 = xf.dimension(function (d) {
      ...
      if (field_name3 == "calculateAge( date_of_birth , IFNULL(incident.occurred_from, incident.date_time ) ) as age") {
        returnValue = d.age;
      }
      if (field_name3 == "race") {
        returnValue = d.race;
      ...
      if (field_name3 == "date_format(incident_date,'%m/%d/%Y') as incident_date") {
        returnValue = d.incident_date;
      }
      ...
      if (field_name3 == "lp_plate_number") {
        returnValue = d.lp_plate_number;
      }
  ...
  function chartStart4() {
    ...
    barchart4 = xf.dimension(function (d) {
      ...
      if (field_name4 == "calculateAge( date_of_birth , IFNULL(incident.occurred_from, incident.date_time ) ) as age") {
        returnValue = d.age;
      }
      if (field_name4 == "race") {
        returnValue = d.race;
      ...
      if (field_name4 == "date_format(incident_date,'%m/%d/%Y') as incident_date") {
        returnValue = d.incident_date;
      }
      ...
      if (field_name4 == "lp_plate_number") {
        returnValue = d.lp_plate_number;
      }
  ...
  function chartStart5() {
    ...
    barchart5 = xf.dimension(function (d) {
      ...
      if (field_name5 == "calculateAge( date_of_birth , IFNULL(incident.occurred_from, incident.date_time ) ) as age") {
        returnValue = d.age;
      }
      ...
      if (field_name5 == "date_format(incident_date,'%m/%d/%Y') as incident_date") {
        returnValue = d.incident_date;
      }
      ...
      if (field_name5 == "lp_plate_number") {
        returnValue = d.lp_plate_number;
      }
  ...
  function chartStart6() {
    ...
    barchart6 = xf.dimension(function (d) {
      ...
      if (field_name6 == "calculateAge( date_of_birth , IFNULL(incident.occurred_from, incident.date_time ) ) as age") {
        returnValue = d.age;
      }
      if (field_name6 == "race") {
        returnValue = d.race;
      ...
      if (field_name6 == "date_format(incident_date,'%m/%d/%Y') as incident_date") {
        returnValue = d.incident_date;
      }
      ...
      if (field_name6 == "lp_plate_number") {
        returnValue = d.lp_plate_number;
      }
